...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="ui-sidebar-mobile-content"
          style={
            {
  ...
  return (
    <div
      className="ui-sidebar-desktop-root group peer"
      data-state={state}
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("ui-sidebar-trigger-btn", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "ui-sidebar-group-label-collapsed",
        className,
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "ui-sidebar-group-action-hitbox",
        "ui-sidebar-group-action-collapsed",
        className,
      )}
      {...props}
    />
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={cn("ui-sidebar-menu-sub-item group/menu-sub-item", className)}
      {...props}
    />
  );
}
